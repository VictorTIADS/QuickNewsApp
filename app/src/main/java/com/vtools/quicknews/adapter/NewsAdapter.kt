...
import com.vtools.quicknews.animation.PulseView
import com.vtools.quicknews.model.Request
import kotlinx.android.synthetic.main.item_news.view.*

class NewsAdapter(val context: Context, val mNews: Request, val listener: InterfaceRecyclerView) :
